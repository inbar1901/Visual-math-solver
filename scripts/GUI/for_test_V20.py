"""
this python file is used by the finalTk and OurTk to perform the detection.
before use notice you need to have the relavent model loaded (line 56-57)
"""
...
def for_test(x_t):
	...
	encoder.load_state_dict(torch.load('/home/inbarnoa/PycharmProjects/MathSolver/versions/onlyOurData - 11/encoder_lr0.00000_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_11.pkl'))
	attn_decoder1.load_state_dict(torch.load('/home/inbarnoa/PycharmProjects/MathSolver/versions/onlyOurData - 11/attn_decoder_lr0.00000_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_11.pkl'))
