...
This module perform the test of the model, original file from HMER
notice you need to update the data is used and the model
'''
import torch
import math
...
valid_datasets=['./offline-train_4.pkl', './train_caption_4.txt']
...
encoder.load_state_dict(torch.load('/home/inbarnoa/PycharmProjects/MathSolver/versions/onlyOurData - 11/encoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_11.pkl'))
attn_decoder1.load_state_dict(torch.load('/home/inbarnoa/PycharmProjects/MathSolver/versions/onlyOurData - 11/attn_decoder_lr0.00001_GN_te1_d05_SGD_bs6_mask_conv_bn_b_xavier_11.pkl'))
